 ...
 * ICEBOX-STUB
 *
 * Placeholder for Aim Trainer. Replace this whole file with the real game. It
...
export default function AimTrainer({ runtime }: AppProps) {
  return (
    <>
      <GameHeader title="Aim Trainer" hint={runtime.standalone ? "Standalone preview" : undefined} />
