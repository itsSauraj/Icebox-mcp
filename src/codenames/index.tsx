 ...
 * ICEBOX-STUB
 *
 * Placeholder for Codenames. Replace this whole file with the real game. It
...
export default function Codenames({ runtime }: AppProps) {
  return (
    <>
      <GameHeader title="Codenames" hint={runtime.standalone ? "Standalone preview" : undefined} />
