 ...
 * ICEBOX-STUB
 *
 * Placeholder for Emoji Riddle. Replace this whole file with the real game. It
...
export default function EmojiRiddle({ runtime }: AppProps) {
  return (
    <>
      <GameHeader title="Emoji Riddle" hint={runtime.standalone ? "Standalone preview" : undefined} />
