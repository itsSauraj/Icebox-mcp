 ...
 * ICEBOX-STUB
 *
 * Placeholder for Story Quest. Replace this whole file with the real game. It
...
export default function StoryQuest({ runtime }: AppProps) {
  return (
    <>
      <GameHeader title="Story Quest" hint={runtime.standalone ? "Standalone preview" : undefined} />
