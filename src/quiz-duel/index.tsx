 ...
 * ICEBOX-STUB
 *
 * Placeholder for Quiz Duel. Replace this whole file with the real game. It
...
export default function QuizDuel({ runtime }: AppProps) {
  return (
    <>
      <GameHeader title="Quiz Duel" hint={runtime.standalone ? "Standalone preview" : undefined} />
