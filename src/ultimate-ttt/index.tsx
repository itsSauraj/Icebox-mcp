 ...
 * ICEBOX-STUB
 *
 * Placeholder for Ultimate Tic-Tac-Toe. Replace this whole file with the real game. It
...
export default function UltimateTtt({ runtime }: AppProps) {
  return (
    <>
      <GameHeader title="Ultimate Tic-Tac-Toe" hint={runtime.standalone ? "Standalone preview" : undefined} />
