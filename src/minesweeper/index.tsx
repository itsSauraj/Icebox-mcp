 ...
 * ICEBOX-STUB
 *
 * Placeholder for Minesweeper. Replace this whole file with the real game. It
...
export default function Minesweeper({ runtime }: AppProps) {
  return (
    <>
      <GameHeader title="Minesweeper" hint={runtime.standalone ? "Standalone preview" : undefined} />
