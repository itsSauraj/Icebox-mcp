 ...
 * ICEBOX-STUB
 *
 * Placeholder for Battleship. Replace this whole file with the real game. It
...
export default function Battleship({ runtime }: AppProps) {
  return (
    <>
      <GameHeader title="Battleship" hint={runtime.standalone ? "Standalone preview" : undefined} />
