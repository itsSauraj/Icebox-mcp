 ...
 * ICEBOX-STUB
 *
 * Placeholder for Higher or Lower. Replace this whole file with the real game. It
...
export default function HigherLower({ runtime }: AppProps) {
  return (
    <>
      <GameHeader title="Higher or Lower" hint={runtime.standalone ? "Standalone preview" : undefined} />
