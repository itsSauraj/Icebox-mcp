 ...
 * ICEBOX-STUB
 *
 * Placeholder for 20 Questions. Replace this whole file with the real game. It
...
export default function TwentyQuestions({ runtime }: AppProps) {
  return (
    <>
      <GameHeader title="20 Questions" hint={runtime.standalone ? "Standalone preview" : undefined} />
