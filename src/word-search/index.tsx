 ...
 * ICEBOX-STUB
 *
 * Placeholder for Word Search. Replace this whole file with the real game. It
...
export default function WordSearch({ runtime }: AppProps) {
  return (
    <>
      <GameHeader title="Word Search" hint={runtime.standalone ? "Standalone preview" : undefined} />
