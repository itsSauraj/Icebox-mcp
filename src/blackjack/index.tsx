 ...
 * ICEBOX-STUB
 *
 * Placeholder for Blackjack. Replace this whole file with the real game. It
...
export default function Blackjack({ runtime }: AppProps) {
  return (
    <>
      <GameHeader title="Blackjack" hint={runtime.standalone ? "Standalone preview" : undefined} />
